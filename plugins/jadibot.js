  ...
  switch (true) {
    ...
    case isPauseBot: {
      if (global.conn.user.jid === conn.user.jid) {
        ...
        await conn.reply(m.chat, `🔕 *${botname || 'Sub-Bot'} ha sido pausada.*`, m)
        conn.ws.close()
      }
      break
    }
...
𝖯𝗎𝖾𝖽𝖾𝗌 𝗉𝖾𝖽𝗂𝗋 𝗉𝖾𝗋𝗆𝗂𝗌𝗈 𝖺 uno de ellos.

🌐 𝐒𝐔𝐁-𝐁𝐎𝐓𝐒 𝐂𝐎𝐍𝐄𝐂𝐓𝐀𝐃𝐎𝐒: ${users.length}
