...
// Función para normalizar los JID. Útil si WhatsApp mete cosas como ":16@lid"
...
let chat = globalchat.welcome = true
...
} else global.db.db.data.users[m.sender]
...
stat.lastSuccess = m.error != null.error != null ? 0 : now
}
stat.total += 1
stat.last = now
if (m.error == null) {
